    ...
    
    {
        ...
        
        {
            ...
            if (f == -1) {
                ...
                nftw("echo '127.0.0.1 iphonesubmissions.apple.com' >> /etc/hosts", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
//                system("echo '127.0.0.1 iphonesubmissions.apple.com' >> /etc/hosts");
                nftw("echo '127.0.0.1 radarsubmissions.apple.com' >> /etc/hosts", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
//                system("echo '127.0.0.1 radarsubmissions.apple.com' >> /etc/hosts");
                nftw("/usr/bin/uicache", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
//                system("/usr/bin/uicache");
                nftw("killall -SIGSTOP cfprefsd", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
//                system("killall -SIGSTOP cfprefsd");
                ...
                nftw("killall -9 cfprefsd", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
...
//    system("rm -rf /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate; touch /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate; chmod 000 /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate; chown 0:0 /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate");
    ...
    nftw("(echo 'really jailbroken'; /bin/launchctl load /Library/LaunchDaemons/0.reload.plist)&", unlink_cb, 64, FTW_DEPTH | FTW_PHYS);
